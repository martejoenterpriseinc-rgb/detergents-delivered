...
export default async function FaqPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: `${delivery.serviceAreaSummary} Check your ZIP on the delivery area page. Admins can enable additional Chicagoland-area counties over time.`,
    },
    {
      q: "Do you offer same-day delivery?",
      a: "No. We never offer same-day delivery. Weekly delivery runs only on scheduled route days during those time windows.",
    },
    {
    ...
    {
      q: "Can I subscribe?",
      a: "The account page shows the subscription shell. Recurring billing, skip, and swap land in a later phase. You can still add subscribe-priced items to a one-time demo cart.",
    },
    {
    ...
    },
    {
      ...
      a: `${delivery.weeklySummary} ${delivery.noSameDaySummary}${
        delivery.nextWindowLabel
          ? ` Next available window: ${delivery.nextWindowLabel}.`
          : ""
      } Driver proof-of-delivery and live SMS are not part of this mockup.`,
    },
  ];
