      ...
      <section className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-6">
          ...
          <p className="max-w-xl text-lg leading-8 text-teal-900/80">
            Detergents Delivered is a standalone local store for liquids, powders,
            pods, dish, paper, and cleaning consumables. Subscribe or order when
            you need a restock. We handle inventory, routes, and the books in one
            place.
          </p>
        ...
        <Card className="flex flex-col items-center gap-4 bg-teal-50 text-center">
          <BrandLogo size={96} />
          <p className="text-lg font-semibold text-teal-950">Clean, convenient, on time</p>
